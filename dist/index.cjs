...
__export(exports_src, {
  ...
  VapiToolFactory: () => VapiToolFactory,
  VapiResponseBuilder: () => VapiResponseBuilder,
  VapiMemory: () => VapiMemory,
...
var import_supermemory = __toESM(require("supermemory"));
...
class SupermemoryClient {
  ...
  constructor(options) {
    ...
    this.client = new import_supermemory.default({
